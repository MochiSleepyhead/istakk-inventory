...
stockOptimizationCreatorFile = 'model/vendor/stockOptimizationTable.php';
...
$(document).ready(function(){
	...
	reportsTableCreator('stockOptimizationDiv', stockOptimizationCreatorFile, 'stockOptimizationTable');
...
function addItem() {
	...
	var itemDemand = $('#itemDemand').val();
	var itemOrderingCost = $('#itemOrderingCost').val();
	var itemHoldingCost = $('#itemHoldingCost').val();
	var itemLeadTime = $('#itemLeadTime').val();
	var itemSafetyStock = $('#itemSafetyStock').val();
...
function getItemDetailsToPopulate(){
	...
	$.ajax({
		...
		success: function(data){
			...
			$('#itemDemand').val(data.demand);
			$('#itemOrderingCost').val(data.ordering_cost);
			$('#itemHoldingCost').val(data.holding_cost);
			$('#itemLeadTime').val(data.lead_time);
			$('#itemSafetyStock').val(data.safety_stock);
