						...
						<div id="itemDetailsTab" class="container-fluid tab-pane active">
							...
							<form action="model/item/insertItem.php" method="POST">
							  ...
							  <div class="form-row">
								...
								<div class="form-group col-md-3">
								  <label for="itemDemand">Demand<span class="requiredIcon">*</span></label>
								  <input type="text" class="form-control" value="0" name="itemDemand" id="itemDemand">
								</div>
								<div class="form-group col-md-3">
								  <label for="itemOrderingCost">Ordering cost<span class="requiredIcon">*</span></label>
								  <input type="text" class="form-control" value="0" name="itemOrderingCost" id="itemOrderingCost">
								</div>
								<div class="form-group col-md-3">
								  <label for="itemHoldingCost">Holding cost<span class="requiredIcon">*</span></label>
								  <input type="text" class="form-control" value="0" name="itemHoldingCost" id="itemHoldingCost">
								</div>
								<div class="form-group col-md-3">
								  <label for="itemLeadTime">Lead Time<span class="requiredIcon">*</span></label>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#stockOptimizationTab">Stock Optimization</a>
						</li>
					</ul>
					...
					<div class="tab-content">
						...
						<div id="stockOptimizationTab" class="container-fluid tab-pane fade">
							<br>
							<p>Use the grid below to get reports for vendors</p>
							<div class="table-responsive" id="stockOptimizationDiv"></div>
						</div>
					</div>
				  </div> 
				</div>
